...
const Header = () => {
  return (
    <div className="w-full md:mt-16 mt-7 md:h-[80vh] h-auto md:px-20 px-5 relative">
      <Navbar />
      <div className="w-full md:mt-48 mt-20 flex md:flex-row flex-col items-start justify-between">
        <div className="flex flex-col md:w-auto w-full">
          ...
          <div className="font-bold text-[#263640] text-[42px] md:max-w-[550px] mt-4">
            Quality is our number one priority here
          </div>
          <p className="font-normal text-[#929a9f] md:max-w-[450px] leading-7 mt-4">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime
            repudiandae sapiente facilis, enim adipisci doloribus facere
            consequatur error labore iure nam.
          </p>
        ...
        <div className="relative">
          ...
          />
          <div className="absolute left-[-40px] top-[60px] w-[450px] bg-[#f5f8fa] h-[570px] z-[-1]"></div>
        </div>
      </div>
    </div>
  );
